...
plt.plot(X_train, y_train, "o", label="train data", alpha=0.6, markersize=4, color="blue")
plt.plot(X_test, y_test, "x", label="test data", alpha=0.6, markersize=4, color="green")
plt.plot(X_train, predicted_y_train, "o", label="model", color="orange", markersize=1, alpha=0.5)
plt.legend(loc="best")
plt.title(
